    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Tabel Bank</h5>
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myModalLabel1">Tambah Data Bank</h5>
                ...
                <form action="{{ route('bank.store') }}" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="first-name-vertical">No. Rekening</label>
                            <input type="text" id="first-name-vertical" required class="form-control" name="no_rekening"
                                placeholder="First Name" />
                        </div>
                    </div>
    ...
    @foreach ($bank as $item)
        <div class="modal fade text-left" id="update{{ $item->id }}" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="myModalLabel1">Edit Data Bank</h5>
                        <button type="button" class="close rounded-pill" data-bs-dismiss="modal" aria-label="Close">
                            <i data-feather="x"></i>
                        </button>
                    </div>
                    <form action="{{ route('bank.update', $item->id) }}" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="first-name-vertical">Nama</label>
                                <input type="text" id="first-name-vertical" required value="{{ $item->no_rekening }}"
                                    class="form-control" name="no_rekening" placeholder="Name" />
                            </div>
        ...
        <div class="modal fade text-left" id="delete{{ $item->id }}" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-scrollable" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('bank.delete', $item->id) }}" method="post">
                        @csrf
                        @method('DELETE')
                        <div class="modal-body">
